...
| **RBI Official RSS + DBIE** | Web / XML | RBI Releases, Bulletins, DBIE Downloads | **Public Domain** | Macro-1 |
...
- **RBI Routing Policy (March 6, 2026)**: Use RBI official RSS XML (`https://www.rbi.org.in/Scripts/rss.aspx`) first, DBIE official downloads (`https://data.rbi.org.in/DBIE/#/`) second, and scraper fallback only during outage emergencies.
