...
- Fallback route records observed: `0`
- PDF quality: `1` documents, `warn=0`, `fail=0`
- Compliance reject log lines: `9`

### Defect Log
- No unresolved defects.

### Remediation List
- No remediation actions required for current gate run.
